...
VALUES 
(101, 'Laptop', 'Apple', 'MacBook Pro 14" (M4 Pro, 32GB RAM, 1TB SSD)', 'AS-BER-2024-01', 1, '2024-04-01', NULL);

-- Geräte für Markus Weber (Product Manager)
INSERT INTO device_entity (id, device_type, manufacturer, designation, assignment_id, employee_number, assignment_start, assignment_end)
VALUES 
(201, 'Laptop', 'Microsoft', 'Surface Laptop 7 (Snapdragon X Elite, 32GB RAM)', 'MW-MUC-2023-01', 2, '2023-10-01', NULL),
(202, 'Tablet', 'Apple', 'iPad Pro 13" (M4, 512GB) inkl. Magic Keyboard', 'MW-MUC-2023-02', 2, '2023-10-15', NULL);

-- Geräte für Lukas Fischer (Data Engineer)
INSERT INTO device_entity (id, device_type, manufacturer, designation, assignment_id, employee_number, assignment_start, assignment_end)
VALUES 
(401, 'Mobile Workstation', 'Dell', 'Precision 5690 (Ultra 7, 64GB RAM, RTX 2000 Ada)', 'LF-HAM-2023-01', 4, '2023-06-01', '2026-06-01'),
...
INSERT INTO device_entity (id, device_type, manufacturer, designation, assignment_id, employee_number, assignment_start, assignment_end)
VALUES 
(501, 'Laptop', 'HP', 'EliteBook 840 G9 (i5, 16GB RAM, 512GB SSD)', 'MN-FRA-2022-01', 5, '2022-01-15', '2024-11-30'),
...
INSERT INTO device_entity (id, device_type, manufacturer, designation, assignment_id, employee_number, assignment_start, assignment_end)
VALUES 
(901, 'Laptop', 'Lenovo', 'ThinkPad T14 Gen 5 (Ryzen 7, 32GB RAM)', NULL, NULL, NULL, NULL),
